...
<!-- generated with COPASI 4.43 (Build 288) (http://www.copasi.org) at 2024-07-04T17:49:03Z -->
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_7155" name="k1" value="0.04"/>
          <Constant key="Parameter_7153" name="k2" value="0.04"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="ProtonPumpRabA" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_7156" name="v" value="0"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4611" name="k" value="0"/>
          <Constant key="Parameter_4613" name="enhancer" value="18"/>
          <Constant key="Parameter_4610" name="pH" value="5.85428"/>
          <Constant key="Parameter_8419" name="pHlimit" value="7.3"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_4" name="FreeFe" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8416" name="k" value="3.36e+06"/>
          <Constant key="Parameter_4612" name="pHlimit" value="6"/>
          <Constant key="Parameter_4614" name="enhancer" value="-9"/>
          <Constant key="Parameter_4608" name="pH" value="5.85428"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[membrane]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
      ...
      <Reaction key="Reaction_5" name="FeTransport" reversible="false" fast="false" addNoise="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4609" name="k1" value="0.38"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[FeTransport]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[FeTransport],ParameterGroup=Parameters,Parameter=k1" value="0.38" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
...
<rdf:Description rdf:about="#ModelParameterSet_6">
    ...
    <InitialState type="initialState">
      0 4.0431214664030426e+27 0 0 2.8906280592000005e+30 0 1.4453140296000001e+27 0 5.8542754251193303 0 0 3360000 552000 2.8906280591999988e+26 0 0 4800000000 2400000 1 0.00020000000000000001 6.4000000000000004 5.4000000000000004 6.5 -9.1999999999999993 
    </InitialState>
  </Model>
  <ListOfTasks>
