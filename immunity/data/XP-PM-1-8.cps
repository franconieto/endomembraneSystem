...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2024-08-01T18:29:00Z -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Compartment_0">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_3" name="protonEn" simulationType="reactions" compartment="Compartment_2" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_3">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_2" name="R-TfaEn" simulationType="reactions" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_2">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_7" name="REn" simulationType="reactions" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_7">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_5" name="TfaEn" simulationType="reactions" compartment="Compartment_2" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_4">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_9" name="FeEn" simulationType="reactions" compartment="Compartment_2" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_9">
      ...
      <Metabolite key="Metabolite_8" name="TfEn" simulationType="reactions" compartment="Compartment_2" addNoise="false">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_10">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_9" name="kpH" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_9">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_8" name="enhancer" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_5">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_4" name="kfreeFe" simulationType="assignment" addNoise="false">
        <Comment>
      ...
      <ModelValue key="ModelValue_3" name="kfreeTfa" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_3">
      ...
      <ModelValue key="ModelValue_2" name="kdisTf" simulationType="assignment" addNoise="false">
        <Comment>
...
O sea unas 50 veces más lerdo que k-1 del paper
        ...
        <Expression>
          &lt;CN=Root,Model=Plasma Membrane,Vector=Compartments[membrane],Reference=InitialVolume>*0.002
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_1" name="kBindTf" simulationType="assignment" addNoise="false">
        <Comment>
          La k+1 se ajusta de auerdo a la Kd de Tf+R - Tf.R 13E-9 M (lodish PNAS) o sea 13E-6 mM
La k-1 se ajusta para que no se libere más del 30% al iniciar la reacción
        </Comment>
        <Expression>
          &lt;CN=Root,Model=Plasma Membrane,Vector=Compartments[membrane],Reference=InitialVolume>*&lt;CN=Root,Model=Plasma Membrane,Vector=Values[kdisTf],Reference=InitialValue>/13E-6
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_6406" name="k" value="112000"/>
          <Constant key="Parameter_11917" name="pHlimit" value="7.3"/>
          <Constant key="Parameter_5150" name="enhancer" value="18"/>
          <Constant key="Parameter_8584" name="pH" value="7"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Plasma Membrane,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            ...
            <CallParameter functionParameter="FunctionParameter_266">
              <SourceParameter reference="Parameter_11917"/>
            </CallParameter>
          </ListOfCallParameters>
        </KineticLaw>
      </Reaction>
      <Reaction key="Reaction_5" name="FreeFe" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_6917" name="enhancer" value="-18"/>
          <Constant key="Parameter_6548" name="pHlimit" value="6.7"/>
          <Constant key="Parameter_7344" name="k" value="66400"/>
          <Constant key="Parameter_7568" name="pH" value="7"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_4" name="disTf" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_7345" name="k1" value="4800"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_3" name="BindTf" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_7348" name="k1" value="8.86154e+14"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Plasma Membrane,Vector=Compartments[membrane]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Compartments[soluble],Vector=Metabolites[protonEn]" value="1.1504699675616002e+26" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Compartments[membrane],Vector=Metabolites[REn]" value="2.931116351421956e+21" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Compartments[membrane],Vector=Metabolites[R-TfEn]" value="1.4640913962219753e+24" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Compartments[soluble],Vector=Metabolites[TfEn]" value="1.2044293362471066e+30" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Values[kfreeFe]" value="66400" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Values[kfreeTfa]" value="112000" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Values[kdisTf]" value="4800" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Values[kBindTf]" value="886153846153846.25" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[FreeTfa]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[FreeTfa],ParameterGroup=Parameters,Parameter=k" value="112000" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[FreeFe]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[FreeFe],ParameterGroup=Parameters,Parameter=k" value="66400" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[disTf]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[disTf],ParameterGroup=Parameters,Parameter=k1" value="4800" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[BindTf]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Plasma Membrane,Vector=Reactions[BindTf],ParameterGroup=Parameters,Parameter=k1" value="886153846153846.25" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
...
<rdf:Description rdf:about="#ModelParameterSet_2">
    ...
    <InitialState type="initialState">
      0 2.931116351421956e+21 0 1.2044293362471066e+30 0 0 1.4640913962219753e+24 7.4001169279263115 66400 112000 4800 886153846153846.25 1.1504699675616002e+26 4800000000 2400000 1 0.00020000000000000001 6.4000000000000004 5.4000000000000004 6.5 -9.1999999999999993 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <GUI>
    <ListOfSliders>
      <Slider key="Slider_2" associatedEntityKey="Task_4" objectCN="CN=Root,Model=Plasma Membrane,Vector=Compartments[soluble],Vector=Metabolites[protonEn],Reference=InitialConcentration" objectType="float" objectValue="3.98e-05" minValue="3.98e-05" maxValue="0.1" tickNumber="1000" tickFactor="100" scaling="linear"/>
      <Slider key="Slider_1" associatedEntityKey="Task_3" objectCN="CN=Root,Model=Plasma Membrane,Vector=Compartments[soluble],Vector=Metabolites[protonEn],Reference=InitialConcentration" objectType="float" objectValue="3.98e-05" minValue="3.98e-05" maxValue="0.1" tickNumber="1000" tickFactor="100" scaling="linear"/>
    </ListOfSliders>
  </GUI>
