...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2024-08-20T14:20:08Z -->
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8825" name="v" value="0"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_10034" name="v" value="0"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_10032" name="k" value="112000"/>
          <Constant key="Parameter_10031" name="enhancer" value="18"/>
          <Constant key="Parameter_9088" name="pH" value="5.85428"/>
          <Constant key="Parameter_10035" name="pHlimit" value="7.3"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[membrane]">
          <ListOfCallParameters>
            ...
            <CallParameter functionParameter="FunctionParameter_273">
              <SourceParameter reference="Parameter_10031"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_272">
              <SourceParameter reference="ModelValue_0"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_266">
              <SourceParameter reference="Parameter_10035"/>
            </CallParameter>
          </ListOfCallParameters>
        </KineticLaw>
      </Reaction>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_10033" name="enhancer" value="-18"/>
          <Constant key="Parameter_10026" name="pHlimit" value="6.7"/>
          <Constant key="Parameter_10028" name="k" value="66400"/>
          <Constant key="Parameter_10027" name="pH" value="5.85428"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[membrane]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
      ...
      <Reaction key="Reaction_4" name="FeTransport" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_10029" name="enhancer" value="-18"/>
          <Constant key="Parameter_10030" name="pHlimit" value="6.7"/>
          <Constant key="Parameter_11389" name="pH" value="5.85428"/>
          <Constant key="Parameter_8819" name="k" value="0.38"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            ...
            <CallParameter functionParameter="FunctionParameter_273">
              <SourceParameter reference="Parameter_10029"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_272">
              <SourceParameter reference="ModelValue_0"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_266">
              <SourceParameter reference="Parameter_10030"/>
            </CallParameter>
          </ListOfCallParameters>
        </KineticLaw>
      </Reaction>
...
<rdf:Description rdf:about="#Reaction_5">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8820" name="k1" value="0.04"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_8820"/>
            </CallParameter>
...
<rdf:Description rdf:about="#Reaction_6">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8823" name="k1" value="0.04"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_8823"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_7" name="BindTf" reversible="false" fast="false" addNoise="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_6862" name="k1" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_8" name="disTf" reversible="false" fast="false" addNoise="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_7" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfProducts>
        ...
        <ListOfConstants>
          <Constant key="Parameter_6865" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[BindTf]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[BindTf],ParameterGroup=Parameters,Parameter=k1" value="7.3846153846153843e+17" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[disTf]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[disTf],ParameterGroup=Parameters,Parameter=k1" value="4000" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
