...
public class CellCopasiStep {
	// This class update the values of metabolites in the Cell according to the time series generated by COPASI
...
//			} else 
		...
		System.out.println(parm.getSchema());
		if (parm != null && parm.getSchema().contains("NH3Cy")) {       //if not, it uses the concentration from the input
		    ...
		    if (value instanceof Number) {
		    	...
		    	cellCopasi.setInitialConcentration("NH3Cy", nh3_concentration);
				localM.put("NH3Cy", nh3_concentration);
